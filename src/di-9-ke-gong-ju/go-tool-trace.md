...
![image](../images/94ec378c617b-RHLGCaz.png)
...
![image](../images/b1e0552819ec-oZj7b95.png)
...
![image](../images/6ab329b6e199-yJh2OMo.png)
...
![image](../images/19331372f935-ilkZLlY.png)
...
![image](../images/8dad24efc98e-w1T3Igo.png)

透過上圖我們可以看到共有 3 個 goroutine，分別是 `runtime.main`、`runtime/trace.Start.func1`、`main.main.func1`，那麼它都做了些什麼事呢，接下來我們可以透過點選具體細項去觀察。如下：

![image](../images/46f71bf55306-gTNLxXi.jpg)

同時也可以看到當前 Goroutine 在整個呼叫耗時中的佔比，以及 GC 清掃和 GC 暫停等待的一些開銷。如果你覺得還不夠，可以把圖表下載下來分析，相當於把整個 Goroutine 執行時掰開來看了，這塊能夠很好的幫助我們**對 Goroutine 執行階段做一個的剖析，可以得知到底慢哪，然後再決定下一步的排查方向**。如下：
...
![image](../images/d7a53b11d94f-ujTD23b.png)
...
![image](../images/e2df257ba577-CGkiPYl.jpg)
...
![image](../images/ad85f24430a1-gdEmYmc.png)
...
![image](../images/b4419f6a4078-sHIkDyi.png)
...
![image](../images/d384856da93a-03e3B8L.jpg)

### Syscall blocking profile

![image](../images/dd42269aa00a-AwYqsrs.jpg)
